...
RecognizeModel::RecognizeModel(const std::string& model)
	 : ctx_params_{/*.use_gpu              =*/false,
		...
		ctx_(whisper_init_from_file_with_params(model.c_str(), ctx_params_)),
...
RecognizeModel::~RecognizeModel() { whisper_free(ctx_); }
