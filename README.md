...
Так же для запуска необходима установленная модель распознавания vosk и корректно указанный путь к ней в `settings.json`. Установить модели vosk можно по данной ссылке - https://alphacephei.com/vosk/models
